/* eslint-disable */
// Generated by Wrangler by running `wrangler types --include-runtime --include-env --strict-vars` (hash: 75ee70cb692ad19ecc3cbc2b7b2c053d)
...
interface __BaseEnv_Env {
	...
	UPPY_WORKFLOW: Workflow<Parameters<import("./src/worker").UppyWorkflow['run']>[0]['payload']>;
	MISE_WORKFLOW: Workflow<Parameters<import("./src/worker").MiseWorkflow['run']>[0]['payload']>;
	NPM_WORKFLOW: Workflow<Parameters<import("./src/worker").NpmWorkflow['run']>[0]['payload']>;
	GITHUB_ACTIONS_WORKFLOW: Workflow<Parameters<import("./src/worker").GithubActionsWorkflow['run']>[0]['payload']>;
}
...
declare namespace NodeJS {
	interface ProcessEnv extends StringifyValues<Pick<Cloudflare.Env, "GITHUB_APP_ID" | "UPDATE_AI_MODEL">> {}
}
